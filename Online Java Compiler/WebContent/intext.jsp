...
<body>
	...
	<div class="subback">
		<div class="inhead">
			<h3>ENCRYPTION PROCESS USING RSA ALGORITHM</h3>
		</div>
		...
		<div class="content2">
			...
			<form method="post" action="EncServlet">
				<input type="hidden" name="skey" value="<%=skey%>"> <input
					type="hidden" name="nvalue" value="<%=nval%>">
				<p>
				<table align="center">
					<tr>
					...
					<tr>
						<td><b>Enter file name:</b></td>
					</tr>
					<tr>
						<td><input type="text" value="" name="fname"></td>
					</tr>
					<tr>
						<td align=center><hr /> <input type="submit" name="compile"
							value="ENCRYPT"></td>
					</tr>
				</table>
			</form>
